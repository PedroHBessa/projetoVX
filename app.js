...
//////////////////FUNCTION CREATION////////////////////////////
	...
	function optionTrigger(num){
	 ...
	 var divBlock = {
	 	...
	 	lineBlock: '<form class="formLine" id="formLine"><div class="lineBlock"> <br> <label for="lineHeight">Line Height:</label> <input type="text" /> <br><br><button>Send</button><br><br></div></form>',
